...
"""Collect EMR stats from current jobflows.
...
def main(args):
    ...
    result =  'timestamp:' + repr(now) 
    result += 'emr_jobflow_num:' + repr(len(job_flow_ids))
    result += 'emr_instances:' + repr(total_instance_count)
    print result


def make_option_parser():
    usage = '%prog [options]'
    description = 'Collect EMR stats from current jobflows.'
